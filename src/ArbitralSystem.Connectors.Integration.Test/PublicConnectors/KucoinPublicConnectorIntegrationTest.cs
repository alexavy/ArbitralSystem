...
{
    [TestClass]
    public class KucoinPublicConnectorIntegrationTest
    {
        ...
        public KucoinPublicConnectorIntegrationTest()
        {
            _dtoConverter = new CryptoExchangeConverter();
            _publicConnector = new KucoinPublicConnector(_dtoConverter);
        }
        ...
        public async Task GetPairInfoTest()
        {
            ...
            if (!pairInfos.Any())
                throw new Exception("Empty pair info list from Kucoin");
