...
{
    [TestClass]
    public class BittrexPublicConnectorIntegrationTest
    {
        ...
        public BittrexPublicConnectorIntegrationTest()
        {
            _dtoConverter = new CryptoExchangeConverter();
            _publicConnector = new BittrexPublicConnector(_dtoConverter);
        }
        ...
        public async Task GetPairInfoTest()
        {
            ...
            if (!pairInfos.Any())
                throw new Exception("Empty pair info list from Bittrex");
