...
{
    [TestClass]
    public class BinancePublicConnectorIntegrationTest
    {
        ...
        public BinancePublicConnectorIntegrationTest()
        {
            _dtoConverter = new CryptoExchangeConverter();
            _publicConnector = new BinancePublicConnector(_dtoConverter);
        }
        ...
        public async Task GetPairInfoTest()
        {
            ...
            if (!pairInfos.Any())
                throw new Exception("Empty pair info list from Binance");
